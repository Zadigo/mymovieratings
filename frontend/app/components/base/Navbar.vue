<template>
  <nav class="fixed top-0 left-0 h-17.5 w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between bg-primary-100 text-primary-700 shadow-[0px_4px_25px_0px_#0000000D] transition-all">
    ...
    <ul class="md:flex hidden items-center gap-10">
      <li><nuxt-link class="hover:text-primary-500/80 transition" to="/">Movies</nuxt-link></li>
    </ul>

    <nuxt-button class="rounded-full" size="xl" variant="outline" color="neutral">
      Get started
    </nuxt-button>

    <nuxt-button aria-label="menu-btn" type="button" class="menu-btn inline-block md:hidden active:scale-90 transition">
