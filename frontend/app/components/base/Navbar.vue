<template>
  <nav class="fixed top-0 left-0 h-17.5 w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between bg-primary-50 text-primary-700 shadow-[0px_4px_25px_0px_#0000000D] transition-all">
