...
const theme = ref<RatingPassThroughOptions>({
  ...
  option: `inline-flex items-center cursor-pointer rounded-full p-focus-visible:outline p-focus-visible:outline-1 p-focus-visible:outline-offset-2 p-focus-visible:outline-primary`
})
</script>
