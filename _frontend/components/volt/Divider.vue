...
const theme = ref<DividerPassThroughOptions>({
  ...
  content: `z-10 bg-surface-0 dark:bg-surface-900 text-surface-700 dark:text-surface-0 p-horizontal:py-0 p-horizontal:px-2 p:vertical:py-2 p:vertical:px-0`
})
</script>
